        ...
        return {
          ...
          link($scope, element, attrs, controller) {
            ...
            function initAutocompleteDrawer() {
              ...
              let drawerElement = angular.element('<div g-places-autocomplete-drawer></div>'),
            ...
            function getCustomPlaceMatches(query, place) {
              let q = `${query}`, // make a copy so we don't interfere with subsequent matches
                terms = [],
                matched_substrings = [],
                fragment,
                termFragments,
